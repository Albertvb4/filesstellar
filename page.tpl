  ...
  <div class="row">
    ...
    <div class="col-12 sg-offcanvas-mainbar">
      ...
      <div class="profile-header">
        ...
        <div class="profile-buttons-wrapper">
          <!-- like -->
          {if $spage['i_like']}
            <button type="button" class="btn btn-md rounded-pill btn-danger js_unlike-page" data-id="{$spage['page_id']}">
              <i class="fa fa-heart"></i>
              <span class="d-none d-xxl-inline-block ml5">{__("Unlike")}</span>
            </button>
          {else}
            <button type="button" class="btn btn-md rounded-pill btn-success js_like-page" data-id="{$spage['page_id']}">
              <i class="fa fa-heart"></i>
          ...
          {if $system['reviews_enabled']}
            {if !$spage['i_admin']}
              <button type="button" class="btn btn-md rounded-pill btn-light" data-toggle="modal" data-url="modules/review.php?do=review&id={$spage['page_id']}">
      ...
      <div class="row">
        ...
        {if $view == ""}
          ...
          <div class="col-lg-4 order-2 order-lg-1">
            ...
            <!-- social links -->
            {if $spage['page_social_faceboook'] || $spage['page_social_twitter'] || $spage['page_social_youtube'] || $spage['page_social_instagram'] || $spage['page_social_linkedin'] || $spage['page_social_vkontakte']}
              <div class="card">
                <div class="card-header bg-transparent">
                ...
                <div class="card-body text-center">
                  {if $spage['page_social_facebook']}
                    <a target="_blank" href="{$spage['page_social_faceboOok']}" class="btn btn-success">
                        <img src="http://localhost/stellarreads/content/logos/casalibro.png" height="20"><font color="white">  CASA DEL LIBRO</font>
                       
                    </a><br><br>
                   
                  {/if}
                  {if $spage['page_social_twitter']}
                    <a target="_blank" href="{$spage['page_social_twitter']}" class="btn btn-primary">
                      <i class="fab fa-amazon"></i><font color="white">  AMAZON</font>
                    </a><br><br>
                    
                  {/if}
                  {if $spage['page_social_youtube']}
                    <a target="_blank" href="{$spage['page_social_youtube']}" class="btn btn-warning">
                      <img src="http://localhost/stellarreads/content/logos/fnac.png" height="20"><font color="white">  FNAC</font>
            ...
            <!-- social links -->
               ...
               <style>
    .btn-casalibro, .btn-casalibro:hover, .btn-casalibro:active, .btn-casalibro:visited {
    ...
    background-color: #717171 !important;
          ...
          <div class="col-lg-8 order-1 order-lg-2">
            ...
            <!-- publisher -->
            {if $spage['i_admin']}
              {include file='_publisher.tpl' _handle="page" _id=$spage['page_id']  _node_can_monetize_content=$spage['can_monetize_content'] _node_monetization_enabled=$spage['page_monetization_enabled'] _node_monetization_plans=$spage['page_monetization_plans']}
            {/if}
            <!-- publisher -->
              ...
              <div class="card-body pb0">
                {if $spage['reviews_count'] > 0}
                  ...
                  {if $spage['reviews_count'] >= $system['max_results_even']}
                    <!-- see-more -->
                    <div class="alert alert-post see-more mt0 mb20 js_see-more" data-get="reviews" data-id="{$spage['page_id']}">
                      <span>{__("See More")}</span>
                      <div class="loader loader_small x-hidden"></div>
                    </div>
                    <!-- see-more -->
                  ...
                  <div class="tab-pane" id="social">
                    <form class="js_ajax-forms" data-url="modules/create.php?type=page&do=edit&edit=social&id={$spage['page_id']}">
                      <div class="card-body">
                        <div class="row">
                          <div class="form-group col-md-6">
                            <label class="form-label">{__("Facebook Profile URL")}dsd</label>
                            <div class="input-group">
                              <span class="input-group-text bg-transparent"><i class="fab fa-facebook fa-lg" style="color: #015E32"></i></span>
